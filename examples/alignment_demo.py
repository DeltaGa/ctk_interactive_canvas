...
def main():
    ...
    ctk.CTkButton(button_frame, text="Align Middle", command=align_middle).grid(row=0, column=1, padx=5)
    ctk.CTkButton(button_frame, text="Align Bottom", command=align_bottom).grid(row=0, column=2, padx=5)
    ctk.CTkButton(button_frame, text="Align Start", command=align_start).grid(row=1, column=0, padx=5, pady=5)
    ctk.CTkButton(button_frame, text="Align Center", command=align_center).grid(row=1, column=1, padx=5, pady=5)
    ctk.CTkButton(button_frame, text="Align End", command=align_end).grid(row=1, column=2, padx=5, pady=5)
    ctk.CTkButton(button_frame, text="Distribute Horizontal", command=distribute_h).grid(row=2, column=0, columnspan=2, padx=5, pady=5)
    ctk.CTkButton(button_frame, text="Distribute Vertical", command=distribute_v).grid(row=2, column=2, columnspan=2, padx=5, pady=5)
